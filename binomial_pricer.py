...
sigma = 0.2#float(sys.argv[1])
DT = 1.0/365.0#float(sys.argv[2])
DTs = 10#int(sys.argv[3])
ANNUAL_INTEREST = 0.015#(float(sys.argv[4]))
...
start_prices_assets = [34, 20, 1]
assets_sigma = [0.29, 0.14, 0.11]
rhos = [0.45, 0.22, 1]
